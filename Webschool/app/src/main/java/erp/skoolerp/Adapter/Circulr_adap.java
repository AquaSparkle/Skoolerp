...
import erp.skoolerp.Pojo.Circ_pojo;
...
public class Circulr_adap extends BaseAdapter
{
    ...
    public Circulr_adap(Context context, ArrayList<Circ_pojo> data)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup)
    {
        ...
        view = inflater.inflate(R.layout.circ_child, null);
