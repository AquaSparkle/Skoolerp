 ...
 */
public class RoundedIV_bordered_black extends ImageView {

    public RoundedIV_bordered_black(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public RoundedIV_bordered_black(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundedIV_bordered_black(Context context, AttributeSet attrs, int defStyle) {
