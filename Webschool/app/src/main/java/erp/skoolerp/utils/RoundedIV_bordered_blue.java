 ...
 */
public class RoundedIV_bordered_blue extends ImageView {

    public RoundedIV_bordered_blue(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public RoundedIV_bordered_blue(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundedIV_bordered_blue(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            System.out.println("TEST_TRY_CATCH:::"+e);
    ...
    public static Bitmap getCroppedBitmap(Bitmap bmp, int radius) {
        ...
        stroke.setColor(Color.parseColor("#3498db"));
